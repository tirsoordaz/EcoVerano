...
Esta práctica tiene el objetivo mostrar cómo se utiliza R para producir un modelo de regresión linear simple entre 2 variables aleatorias. Se muestra cómo calcular los parámetros de las fórmulas manualmente y también cómo utilizar la función lm() de R.
